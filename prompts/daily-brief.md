...
The brief is rendered from a JSON document conforming to
`data/brief.schema.json`. Populate ALL required fields. The Jinja2
templates in `templates/` produce the published HTML.
